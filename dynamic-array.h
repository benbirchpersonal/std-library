...
template<class _T>
constexpr inline dynArr<_T>::dynArr() noexcept
{
	_ArrayLocation			=		malloc(sizeof(_T) * DEFAULT_ARRAYSIZE);
	_ArrayLength			=		0;
...
template<class _T>
constexpr inline dynArr<_T>::dynArr(size_t reservedSpace) noexcept
{
...
template<class _T>
constexpr inline dynArr<_T>::dynArr(dynArr<_T>& copiedArr) noexcept
{
	_ArrayLocation		    =		malloc(sizeof(_T) * copiedArr._ArrayLength);
...
template<class _T>
constexpr inline dynArr<_T>::dynArr(std::initializer_list<_T> _List) noexcept
{
